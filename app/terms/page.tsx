...
export const metadata: Metadata = {
  title: "Terms | G's Stock",
  description: "Terms for browsing and ordering from the G's Stock research catalog.",
}

export default function TermsPage() {
  return (
    <InfoPage eyebrow="Policy" title="Terms of use">
      <p>G&apos;s Stock is a research-supply catalog. Every compound is sold for laboratory research use only. Nothing on this site is medical advice, a diagnosis, or a recommendation for human or animal use.</p>
