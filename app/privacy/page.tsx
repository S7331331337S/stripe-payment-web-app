...
export const metadata: Metadata = {
  title: "Privacy | G's Stock",
  description: "How G's Stock handles cart data, checkout, and catalog questions.",
}
...
export default function PrivacyPage() {
  return (
    <InfoPage eyebrow="Policy" title="Privacy">
      ...
      <p>When you check out, Stripe collects payment, shipping, and contact details. G&apos;s Stock does not store card numbers on this site. Stripe&apos;s privacy policy covers that checkout data.</p>
